  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">Nuestras herraminetas</h1>
      </div>
    </div>
  </div>
</section>
...
<section class="section pb-0">
  <div class="container">
    <div class="row no-gutters">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="card hover-shadow">
          <img src="images/team/member-5.jpg" alt="team-member" class="card-img-top">
          <div class="card-body text-center position-relative zindex-1">
            <h4><a class="text-dark" href="team-single.php">Sara Adams</a></h4>
            <i>Designer</i>
          </div>
