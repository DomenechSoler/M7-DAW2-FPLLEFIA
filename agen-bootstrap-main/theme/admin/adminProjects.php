...
<body>
    <div class="container mt-5">
        <h1 class="mb-4 text-center">Administrar Proyectos</h1>
        <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#addProjectModal">Añadir proyecto</button>
            ...
            <tbody>
                <?php foreach ($proyectos as $proyecto) : ?>
                    <tr>
                        ...
                        <td><img src="../theme/uploads/<?= htmlspecialchars($proyecto['thumbnail']) ?>" width="100px" height="100px" alt="imagen de proyecto"></td>
                        <td>
                            <div class="d-flex">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addProjectModalLabel">Formulario añadir proyecto</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="projects/add-project.php" method="POST" enctype="multipart/form-data">
