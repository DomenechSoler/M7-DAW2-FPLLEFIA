            ...
            <div class="row align-items-center">
                <div class="col-md-3 col-6">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="portfolio.php" class="text-light d-block mb-3">Portfolio</a></li>
                    </ul>
                </div>
                <div class="col-md-3 col-6">
                ...
                <div class="col-md-6">
                    <div class="bg-white p-4">
                        <h3>Contáctanos</h3>
                        <form action="#">
                            <input type="text" id="name" name="name" class="form-control mb-4 px-0" placeholder="Nombre y apellidos">
